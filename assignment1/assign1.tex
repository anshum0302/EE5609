...
%
\begin{lstlisting}
https://github.com/anshum0302/EE5609/tree/master/codes
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/anshum0302/EE5609
\end{lstlisting}
%
...
Resultant $\vec{R}$ of two vectors $\vec{a}$ and $\vec{b}$ is the sum of two vectors.So $\vec{R}$ = $\vec{a}$+$\vec{b}$ = \myvec{a1\\a2\\a3}+ \myvec{b1\\b2\\b3} = \myvec{a1+b1\\a2+b2\\a3+b3}.\\
...
$\vec{R}$=$\vec{a}$+$\vec{b}$=\myvec{2\\ 3\\ -1}+\myvec{1\\ -2\\ 1} = \myvec{2+1\\ 3-2\\ -1+1} = \myvec{3\\ 1\\ 0}.\\
Magnitude of $\vec{R}$ is $\norm{\vec{R}}$ = $\sqrt{3^2+1^2+0^2}$ = $\sqrt{10}$.\\
Then unit vector $\vec{r}$ along $\vec{R}$ is $\frac{\vec{R}}{\norm{\vec{R}}}$ = $\frac{1}{\sqrt{10}}\myvec{3\\ 1\\ 0}$ \\
Then vector of magnitude 5 units parallel to resultant $\vec{R}$ is 5$\vec{r}$ = $\frac{5}{\sqrt{10}}\myvec{3\\ 1\\ 0}$ = $\myvec{3\sqrt{\frac{5}{2}}\\ \sqrt{\frac{5}{2}}\\ 0}$ = \myvec{4.7434\\ 1.5811\\ 0}\\
\end{document}
