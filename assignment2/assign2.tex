...
Let \rupee{$x$} be invested in bonds of the first type.Thus \rupee{(30000-$x$)} will be invested in the other type.We represent investment per bond by matrix $\vec{P}$.
\begin{align}
...
\end{align}
Now in part (a) total annual interest = \rupee{1800}.So using \eqref{eqn}
\begin{align*}
  ...
  x &= 15000
\end{align*}
Thus,in part (a) investment in bond paying 5\% interest is \rupee{15000} and investment in bond paying 7\% interest is \rupee(30000-15000) = \rupee{15000}.In part (b) total annual interest = \rupee{2000}.So using \eqref{eqn}
\begin{align*}
  ...
  x &= 5000
\end{align*}
Thus,in part (b) investment in bond paying 5\% interest is \rupee{5000} and investment in bond paying 7\% interest is \rupee(30000-5000) = \rupee{25000}.
\end{document}
